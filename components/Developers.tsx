  ...
  return (
    <section id="developers" className="py-20 md:py-32 bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-white/80">{t.developers.title}</h2>
