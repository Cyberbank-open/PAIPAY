    ...
    <section id="faq" className="py-20 md:py-32 bg-white border-t border-gray-50">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-14">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">常见问题</h2>
          <p className="text-gray-500 mt-3 text-sm md:text-base tracking-wide">关于产品、安全与集成的解答</p>
        </div>
